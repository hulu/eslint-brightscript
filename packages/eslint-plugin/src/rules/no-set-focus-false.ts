...
export let noSetFocusFalse = {
    meta: {
        type: "problem",
        messages: {
            noSetFocusFalseId: "Don't use setFocus(false). It can cause focus issues within the firmware/runtime."
        },
        docs: {
            description: "Don't use setFocus(false). It can cause focus issues within the firmware/runtime.",
